...
public interface MethodDescriptor extends ExecutableDescriptor<Method> {
    ...
    @Language("RegExp")
    String PATTERN = TypeDescriptor.CLASS_NAME_PATTERN + "#" + NAME_PATTERN + "\\((?:" + TypeDescriptor.PATTERN + ")*\\)";
    ...
    static MethodDescriptor of(
        ...
        return MemberDescriptorOps.newMethodDescriptor(declaringClass, name, arguments);
    }
